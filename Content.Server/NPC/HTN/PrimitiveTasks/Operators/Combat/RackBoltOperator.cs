...
public sealed partial class RackBoltOperator : HTNOperator
{
    ...
    public override HTNOperatorStatus Update(NPCBlackboard blackboard, float frameTime)
    {
        ...
        // Racking is owned by the gun system. Raising its normal in-hand interaction keeps
        // HTN compatible with current chamber and bolt implementations.
        var useEvent = new UseInHandEvent(owner);
        _entManager.EventBus.RaiseLocalEvent(gunUid.Value, useEvent);

        return useEvent.Handled ? HTNOperatorStatus.Finished : HTNOperatorStatus.Failed;
    }
}
