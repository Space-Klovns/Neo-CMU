...
public sealed partial class NPCRetaliationSystem : EntitySystem
{
    ...
    [Dependency] private _KS14.NPC.Systems.NpcRetaliationWarningSystem _retaliationWarningSystem = default!;
    ...
    private void OnDamageChanged(Entity<NPCRetaliationComponent> ent, ref DamageChangedEvent args)
    {
        ...
        RetaliateOnThrowerIfPossible(ent, origin);
    }
    ...
    public bool TryRetaliate(Entity<NPCRetaliationComponent> ent, EntityUid target, bool tryWarn = false)
    {
        ...
        if (tryWarn &&
            ...
            CompOrNull<MobStateComponent>(ent.Owner)?.CurrentState == Shared.Mobs.MobState.Alive &&
